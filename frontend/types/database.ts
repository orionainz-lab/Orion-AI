// Generated by Supabase MCP - Phase 3 & Phase 6B Database Types
// Date: 2026-01-31
// Project: Orion AI - The Secure Context (Data & RAG) + Advanced Features
  ...
  public: {
    Tables: {
      ...
      user_installed_connectors: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_installed_connectors_marketplace_connector_id_fkey"
            columns: ["marketplace_connector_id"]
            isOneToOne: false
            referencedRelation: "connector_marketplace"
            referencedColumns: ["id"]
          },
        ]
      }
...
// Convenience type aliases for Phase 6B tables
